...
EXTERNAL(LIB_NAME "boost"       LIB_VERSION ${BOOST_VERSION}       BIN_ROOT "${PROCESS_3RD_BIN}")
EXTERNAL(LIB_NAME "picojson"    LIB_VERSION ${PICOJSON_VERSION}    BIN_ROOT "${PROCESS_3RD_BIN}")
EXTERNAL(LIB_NAME "http_parser" LIB_VERSION ${HTTP_PARSER_VERSION} BIN_ROOT "${PROCESS_3RD_BIN}")
EXTERNAL(LIB_NAME "libev"       LIB_VERSION ${LIBEV_VERSION}       BIN_ROOT "${PROCESS_3RD_BIN}")
EXTERNAL(LIB_NAME "libevent"    LIB_VERSION ${LIBEVENT_VERSION}    BIN_ROOT "${PROCESS_3RD_BIN}")
EXTERNAL(LIB_NAME "libapr"      LIB_VERSION ${LIBAPR_VERSION}      BIN_ROOT "${PROCESS_3RD_BIN}")
EXTERNAL(LIB_NAME "protobuf"    LIB_VERSION ${PROTOBUF_VERSION}    BIN_ROOT "${PROCESS_3RD_BIN}")

if (NOT WIN32)
  EXTERNAL(LIB_NAME "glog" LIB_VERSION ${GLOG_VERSION} BIN_ROOT "${PROCESS_3RD_BIN}")
elseif (WIN32)
  # Glog 0.3.3 does not compile out of the box on Windows. Therefore, we
  # require 0.3.4.
  EXTERNAL(LIB_NAME "glog" "LIB_VERSION 0.3.4" BIN_ROOT "${PROCESS_3RD_BIN}")
  ...
  EXTERNAL(LIB_NAME "curl" LIB_VERSION ${CURL_VERSION} BIN_ROOT "${PROCESS_3RD_BIN}")
endif (NOT WIN32)
